                    ...
                    <form action="update_back.php" method="post" enctype="multipart/form-data" id="formID" class="formular">
                        <table width="100%" border="1" cellspacing="0" cellpadding="0">
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td><input type="file" name="new_images[]" class="validate[required]" /></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 90%;"><input style="width: 99%;height: 60px;" type="text" name="author" value="<?php echo $row['author'];?>"/></td>
                            </tr>
                            <tr>
                                <td style="text-align: center;">Date</td>
                                <td style="width: 90%;"><input style="width: 99%;height: 60px;" type="text" name="date" value="<?php echo $row['date'];?>"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="height: 50px;border:0;padding-left:20px;letter-spacing:1px;font-size:20px;">SEO</td>
                            </tr>
                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 90%;"><input style="width: 99%;height: 60px;" type="text" name="meta_title" value="<?php echo $row['meta_title'];?>"/></td>
                            </tr>
                            <tr>
                                <td style="text-align: center;">Meta Description</td>
                                <td style="width: 90%;"><input style="width: 99%;height: 60px;" type="text" name="meta_description" value="<?php echo $row['meta_description'];?>"/></td>
                            </tr>
